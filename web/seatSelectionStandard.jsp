            ...
            <div class="col-2 border border-primary rounded text-center">
                ...
                <div class="float-right">
                    <%
                        for (int i = 1; i <= 30; i++) {
                    %>
                    <a href="#" id="<%=i%>d" style="font-size: 30px; color: limegreen;"><i class="fas fa-user"></i></a>
                    <a href="#" id="<%=i%>e" style="font-size: 30px; color: limegreen;"><i class="fas fa-user"></i></a>
                    <a href="#" id="<%=i%>f" style="font-size: 30px; color: limegreen;"><i class="fas fa-user"></i></a></br>
                    <%
                        }
                    %>
                </div>
