...
<html>
    ...
    <body>
        <%
            if (loggedInUser != null) {
                ...
                if (session.getAttribute("departureFlight") != null && numPassengers > 0) {
                    ...
                    double totalPrice = departureCheckedBaggagePrice;
        ...
        <h3 class="ml-3">
            ...
            <span class="float-md-right mr-md-3"><br class="d-flex d-md-none"><hr class="d-flex d-md-none"><%=dataBundle.getString("paymentDetails_total")%> <%=currencyFormatter.format(departureCheckedBaggagePrice)%>&nbsp;&nbsp;</span>
        </h3>
        <hr></br>
        ...
        <div class="row d-none d-md-flex">
            ...
            <div class="col-6">
                <form action="Servlet" method="post">
                    ...
                    </br><button type="submit" class="btn btn-success float-right"><%=dataBundle.getString("paymentDetails_payCheckedBaggage")%></button>
        ...
        <div class="row d-flex d-md-none">
            <div class="col-12">
                <form action="Servlet" method="post">
                    ...
                    </br><button type="submit" class="btn btn-success float-right mr-3"><%=dataBundle.getString("paymentDetails_payCheckedBaggage")%></button>
                    <input type="hidden" name ="action" value="payCheckedBaggage" />
                </form>
            </div>
        </div>
...
//                      value: '0.01'
                ...
                onApprove: function (data, actions) {
                    return actions.order.capture().then(function (details) {
                        ...
                        window.location = 'http://localhost:8084/microhard_airlines/Servlet?action=payCheckedBaggage&paidWithPaypal=true';
